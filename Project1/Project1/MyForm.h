...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button8->Location = System::Drawing::Point(456, 410);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(125, 45);
			...
			this->button9->Location = System::Drawing::Point(326, 410);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(135, 45);
			...
			this->ClientSize = System::Drawing::Size(628, 461);
...
#pragma endregion
	...
	private: void print() {
		if (size == 0) {
		   ...
		   // Найти полином по названию
	private: System::Void button11_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show(To_SysString(find(To_string(textBox9->Text))), "MessageBox for multuply on number",
			MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
	}
		   //Выбор таблиыц 
